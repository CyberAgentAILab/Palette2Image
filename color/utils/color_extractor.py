...
import cv2
import numpy as np
from color.utils.color_convertor import lab_to_rgb, rgb_to_lab
...
def get_colors(image, color_numbers, sort):
    ...
    (colors, colors_lab, rates, palette) = create_palette(hist, real_centers, sort)
...
def create_palette(hist, centroids, sort):
    minRate = 0.01
